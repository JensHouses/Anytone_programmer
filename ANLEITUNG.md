...
* das **USB-Programmierkabel** (wichtig: ein Kabel mit Datenadern;
  manche reinen Ladekabel sehen gleich aus, übertragen aber keine Daten)
...
* Es öffnet sich ein schwarzes Textfenster. **Lassen Sie es offen**, denn
  darin läuft das Programm. Beim allerersten Start unter Windows wird einmalig
...
| Problem | Lösung |
|---|---|
| Windows: „Python ist nicht installiert“ oder das Fenster schließt sofort | Python wie in Schritt 2 installieren. Wenn es schon installiert ist, wurde vermutlich das Häkchen **„Add python.exe to PATH“** vergessen. Installieren Sie Python einfach noch einmal, diesmal mit Häkchen. |
...
| „(kein Port gefunden)“ obwohl das Gerät angeschlossen ist | Ist das Gerät eingeschaltet? Steckt das Kabel fest? Häufigste Ursache: ein reines **Ladekabel** ohne Datenadern. Probieren Sie ein anderes USB-Kabel. Danach in der Oberfläche „Ports neu suchen“ klicken. |
